...
\begin{example}
  Dado \(\mathbb F_q\) la aplicación biyectiva dada por \(\sigma_p : \mathbb F_q \to \mathbb F_q\) tal que \(\sigma_p(\alpha) = \alpha^p\) para todo \(\alpha \in \mathbb F_q\) es un automorfismo, conocido como \emph{automorfismo de Frobenius}.
\end{example}

Al grupo que forman los automorfismos de \(\mathbb F_q\) lo llamamos \emph{grupo de Galois} de \(\mathbb F_q\).
Así, definomos el \emph{orden} de un automorfismo como el menor \(n\) tal que \(\sigma^n(\alpha) = \alpha\) para todo \(\alpha \in \mathbb F_q\).

Decimos que un elemento \(\alpha \in \mathbb F_q\) queda \emph{fijo} por un automorfismo \(\sigma\) si \(\sigma(\alpha) = \alpha\).
El conjunto de los elementos de \(\mathbb F_q\) que quedan fijos por un automorfismo \(\sigma\) forma un subcuerpo de \(\mathbb F_q\) y se denomina \emph{subuerpo fijo de} \(\mathbb F_q\) por \(\sigma\).
