...
\begin{definition}
  ...
  \marginpar{Un ideal bilátero será principal si verifica cualquiera de las dos condiciones.}
...
% TODO: qué es un subcuerpo primo, eso no lo he explicado
...
El siguiente resultado nos proporciona la existencia y unicidad de divisores de un polinomio en \(\mathbb F_q[x]\).
...
En esta subsección vamos a construir cuerpos finitos a partir del cociente de anillos de polinomios por polinomios irreducibles.
%\begin{proof}
