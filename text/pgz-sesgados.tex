...
Podemos asumir sin pérdida de generalidad que  \(\mathcal C\) es un código RS sesgado en sentido estricto, es decir, que bajo la definición que dimos en el capítulo anterior, el valor \(r = 0\).
...
Veamos a continuación algunos ejemplos utilizando para ello la implementación en Sage comentada en el anexo \ref{annex:pgz-sage}.
