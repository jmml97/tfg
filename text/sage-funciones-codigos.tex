\chapter{Implementación en Sage de algunas funciones sobre códigos}
...
\lstinputlisting[language=Python, caption=Cálculo en Sage de conjuntos característicos]{../code/cto-caracteristico.sage}